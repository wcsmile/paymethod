...
function create_basic_install(Vue) {
  ...
  Vue.component(Object(utils["a" /* camelize */])("-" + name), this);
}
...
/* harmony default export */ var es_radio = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      style: _vm.iconStyle,
      attrs: {
        "name": _vm.checked ? 'checked' : 'circle'
      }
...
/* harmony default export */ var address_list = (create({
  render: function render() {
    ...
    }), 1) : _vm._e(), _vm._t("default"), _c('van-button', {
      class: _vm.b('add'),
      attrs: {
        "square": "",
        "size": "large",
...
/* harmony default export */ var card = (create({
  render: function render() {
    ...
    }, [_vm.thumb || _vm.$slots.thumb ? _c('a', {
      class: _vm.b('thumb'),
      attrs: {
        "href": _vm.thumbLink
      }
    }, [_vm._t("thumb", [_vm.lazyLoad ? _c('img', {
      directives: [{
        name: "lazy",
        rawName: "v-lazy",
        value: _vm.thumb,
    ...
    }, [_vm._v("\n        " + _vm._s(_vm.desc) + "\n      ")]) : _vm._e()]), _vm._t("tags"), _c('div', {
      staticClass: "van-card__bottom"
    }, [_vm.isDef(_vm.price) ? _c('div', {
      class: _vm.b('price')
    }, [_vm._v("\n        " + _vm._s(_vm.currency) + " " + _vm._s(_vm.price) + "\n      ")]) : _vm._e(), _vm.isDef(_vm.originPrice) ? _c('div', {
      class: _vm.b('origin-price')
    }, [_vm._v("\n        " + _vm._s(_vm.currency) + " " + _vm._s(_vm.originPrice) + "\n      ")]) : _vm._e(), _vm.isDef(_vm.num) ? _c('div', {
      class: _vm.b('num')
    }, [_vm._v("\n        x " + _vm._s(_vm.num) + "\n      ")]) : _vm._e()])], 2), _vm.$slots.footer ? _c('div', {
      class: _vm.b('footer')
  ...
  render: function render() {
    ...
    return _c('cell', {
      ...
      attrs: {
        ...
        "icon": _vm.type === 'edit' ? 'contact' : 'add-square'
      },
      on: {
        "click": _vm.onClick
      }
...
/* harmony default export */ var coupon_list_Item = (create({
  ...
  computed: {
    ...
    faceAmount: function faceAmount() {
      return this.data.denominations !== 0 ? "<span>" + this.currency + "</span> " + this.formatAmount(this.data.denominations) : this.data.discount !== 0 ? this.formatDiscount(this.data.discount) : '';
    },
  ...
  computed: {
    ...
    columns: function columns() {
      ...
      var results = this.ranges.map(function (_ref) {
        ...
        var values = _this.times(rangeArr[1] - rangeArr[0] + 1, function (index) {
  ...
  render: function render() {
    ...
    return _c('div', {
      ...
      return _c('i', {
        ...
        style: index - 1 === _vm.activeIndicator ? _vm.indicatorStyle : null
      });
    }), 0) : _vm._e()])], 2);
  },
  name: 'swipe',
...
/* harmony default export */ var password_input = (create({
  render: function render() {
    ...
    }), 0), _vm.errorInfo || _vm.info ? _c('div', {
